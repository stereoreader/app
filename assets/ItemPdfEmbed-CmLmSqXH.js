...
`],{type:"application/javascript"})),{type:"module"}),s=new En(i,{wasmUrl:t,logger:r,fontFallback:a}),l=URL.createObjectURL(new Blob([`async function encodeImage(imageData, imageType, quality) {
...
`],{type:"application/javascript"})),p=new yn(o??2,l,r);return new mn(s,{imageConverter:Pn(p),logger:r})}const Sn=Object.freeze(Object.defineProperty({__proto__:null,createPdfiumEngine:An},Symbol.toStringTag,{value:"Module"}));function xn(t="latest"){return{jp:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-jp@${t}/fonts`,kr:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-kr@${t}/fonts`,sc:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-sc@${t}/fonts`,tc:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-tc@${t}/fonts`,arabic:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-arabic@${t}/fonts`,hebrew:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-hebrew@${t}/fonts`,latin:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-latin@${t}/fonts`}}function _(t,n){return t.map(e=>({url:`${n}/${e.file}`,weight:e.weight,italic:e.italic}))}function Cn(t){return{fonts:{[f.SHIFTJIS]:_(fn,t.jp),[f.HANGEUL]:_(Fn,t.kr),[f.GB2312]:_(hn,t.sc),[f.CHINESEBIG5]:_(_n,t.tc),[f.ARABIC]:_(bn,t.arabic),[f.HEBREW]:_(Dn,t.hebrew),[f.CYRILLIC]:_(L,t.latin),[f.GREEK]:_(L,t.latin),[f.VIETNAMESE]:_(L,t.latin)}}}const Mn=xn("latest");Cn(Mn);let v=null,E=null;async function On(){if(E)return E;if(v)return await v;const{promise:t,reject:n,resolve:e}=Promise.withResolvers();v=t;const r=(await B(async()=>{const{default:a}=await import("./pdfium-fEELsW2V.js");return{default:a}},[])).default,o=new URL(r,window.location.origin).toString();try{const{createPdfiumEngine:a}=await B(async()=>{const{createPdfiumEngine:i}=await Promise.resolve().then(()=>Sn);return{createPdfiumEngine:i}},void 0);return E=a(o,{encoderPoolSize:4}),e(E),E}catch(a){n(a)}}async function Tn(){v=null;const t=E?.destroy();return E=null,t?.toPromise()}class Gn extends V{constructor(n){super(n)}calcRow(n,e,r){const o=r/this.aspectRatio+k.chunkGap;return e.push({offset:n,height:o,lines:[{idx:0,chunkPos:0,chunk:this,text:""}],lineHeight:o}),o}images={};renderTask;onMounted(n){}onUnmounted(n){A(this).renderTask?.abort({message:"Chunk unmounted"})}async renderPage(n){if(typeof this.images[n]=="object")return;this.images[n]={};const e=A(this);try{const r=window.devicePixelRatio||1,o=n/this.pageWidth*r;e.renderTask=await e.item.renderPage(e.idx,{scaleFactor:o,imageType:"image/png"});const a=await e.renderTask.toPromise();delete e.renderTask,this.images[n]={url:e.item.createObjectURL(a),width:e.pageWidth*o/r,height:e.pageHeight*o/r,dpr:r}}catch{delete this.images[n]}}component({lines:n,width:e},r){const o={backgroundColor:"white",backgroundPosition:"center",backgroundRepeat:"no-repeat",height:r.height-k.chunkGap+"px"},a=this.images[e];a?"url"in a&&(o.backgroundImage=`url(${a.url})`,a.dpr===1||(o.backgroundSize=`${a.width}px ${a.height}px`)):this.renderPage(e),k.pdfInvert&&(o.filter="invert(1)");const i=$.current.activeChunk.idx===this.idx;return[q("div",{idx:n?.[0],class:{active:i},style:o})]}}class Rn extends ${get iconColor(){return"#FA0F00"}get icon(){return"pdf-file"}supports(n){return n!=="fontSize"}constructor(){super();const n=["engine","document"];for(const e of n)Object.defineProperty(this,e,{writable:!0,configurable:!1,enumerable:!1,value:this[e]})}async onClose(){await this.engine.closeAllDocuments().toPromise(),this.document=null,await Tn();for(const n of this._chunks)n.images={};super.onClose()}async openDocument(){const n=A(this);n.engine=await On(),n.document=await n.engine.openDocumentBuffer({id:n.id,content:n.data}).toPromise()}async renderPage(n,e){const r=A(this);return await r.openDocument(),r.engine.renderPage(r.document,r.document.pages[n],e)}async parseInfo(){const n=A(this);await n.openDocument();{const o=await(await n.renderPage(0,{imageType:"image/png"})).toPromise(),{ImageUtils:a}=await B(async()=>{const{ImageUtils:i}=await import("./image-Cl8duVbC.js");return{ImageUtils:i}},[]);this.thumbnailUrl=await a.scaleToDataURL(o,null,3e4,300,"jpeg")}const e=await n.engine.getMetadata(n.document).toPromise();e.title&&!e.title.toLowerCase().includes("anonymous")&&(this.title=e.title),e.author&&!e.author.toLowerCase().includes("anonymous")&&(this.author=e.author)}async parseData(){const n=A(this);await n.openDocument();for(let e=0;e<n.document.pageCount;e++){const r=await n.document.pages[e],{width:o,height:a}=r.size,i=o/a;n.addChunk({offset:e,pageIdx:e,pageWidth:o,pageHeight:a,aspectRatio:i,item:n},Gn)}return this}get chunks(){return this._chunks}}export{Rn as ItemPdf,Rn as default};
