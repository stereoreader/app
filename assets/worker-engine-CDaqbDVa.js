...
`],{type:"application/javascript"})),{type:"module"}),s=new on(i,{wasmUrl:t,logger:r,fontFallback:a}),l=URL.createObjectURL(new Blob([`async function encodeImage(imageData, imageType, quality) {
...
`],{type:"application/javascript"})),p=new an(o??2,l,r);return new en(s,{imageConverter:rn(p),logger:r})}export{sn as createPdfiumEngine};
